...
##### notes
Since it was a collaborative aspect with others, I thought about how I could relate it to my Stage 1 sketch even a little part. I was looking through other people's sketches and I found ODESSSO's sketch, I thought it would create a great combination between ODESSSO's clean background with the emojis that I used. The sun, the moon, and all the objects, in the sky are known as the Celestial Bodies. Since these photos are based on sky background, the sun, the moon, and the cloud...options would suits the concept of this sketch.

Collaborative Aspect:

- I let 'imageChangeInterval' from 60 to 100, so that the audience get to have more times for selection.
- 
### 🟩 Stage 3
- Name/Alias:
- Github account:
